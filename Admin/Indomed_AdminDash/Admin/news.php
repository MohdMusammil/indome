...
<h3 class="inner-tittle two">News List</h3>  <a href="createnews.php">                                                                                   
<button type="submit" name="submit" class="btn btn-default">Create News</button></a>
<div class="graph">
...
//display All records
	...
	echo "<Tr><th>Sr.No</th><th>News Title</th><th>Nes Desc</th>
	<th>URL</th><th>Pic</th><th>Delete</th></tR>";
	...
	echo "<tr>";
	echo "<td>".$i."</td>";
	echo "<td>".$res['nname']."</td>";
	echo "<td>".$ndesc."</td>";
	echo "<td>".$res['nurl']."</td>";
	echo "<td><img src='image/$nn/$img'
	width='100px'/></td>";
...
<!-- Bootstrap Core JavaScript -->
   ...
   <script>
			function deleteRecord(x)
			{
				...
				{
				window.location.href='ndelete.php?n_id='+x;	
