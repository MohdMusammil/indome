...
if(isset($save))
{
	$query="select * from article where aname='$an' ";
   ...
   $query="insert into article values('','$an','$aurl')";	
	//upload image
   ...
   <body>
      ...
      <div class="page-container">
         ...
         <div class="left-content">
			...
			<table>
				<tr>
					<td class="form-group col-sm-4 control-label">Article Title</tD>
					<td><input type="text" class="form-control1" name="an"/></td>
				</tR>
				<tr>
					<td class="form-group col-sm-4 control-label">Article URL</tD>
					<td><input type="text" class="form-control1" name="aurl"/></td>
				</tR>
				<tr>               
