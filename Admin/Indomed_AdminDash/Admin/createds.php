...
if(isset($save))
{
	$query="select * from ds where dname='$dn' ";
   ...
   $query="insert into ds values('','$dn','$durl')";	
	//upload image
   ...
   <body>
      ...
      <div class="page-container">
         ...
         <div class="left-content">
               ...
               <div class="outter-wp">
                  <div class="set-1">
                     <div class="graph-2 general">
                        <h3 class="inner-tittle two">Create DataSheet</h3>
                        <div class="grid-1">
                           <div class="form-body">
			...
			<table>
				<tr>
					<td class="form-group col-sm-4 control-label">DataSheet Title</tD>
					<td><input type="text" class="form-control1" name="dn"/></td>
				</tR>
				<tr>
					<td class="form-group col-sm-4 control-label">DS URL</tD>
					<td><input type="text" class="form-control1" name="durl"/></td>
				</tR>
				<tr>               
...
//display All records
	...
	echo "<Tr><th>Sr.No</th><th>DataSheet Title</th><th>URL</th>
	<th>Delete</th></tR>";
	
	$sql=mysqli_query($conn,"select * from ds");
	$i=1;
...
?>                      <!-- <tr> <th scope="row">EEA001</th> <td>Client Name 1</td> <td>Type1</td> <td>April, 2019</td> </tr> 
	  ...
	  <script>
			function deleteRecord(x)
			{
				...
				{
				window.location.href='dsdelete.php?d_id='+x;	
