...
if(isset($save))
{
	$query="select * from gal where name='$gn' ";
   ...
   $query="insert into gal values('','$gn','$image')";	
	//upload image
	mkdir("image/$gn");
	move_uploaded_file($_FILES['pic']['tmp_name'],"image/$gn/".$_FILES['pic']['name']);
   ...
   <body>
      ...
      <div class="page-container">
         ...
         <div class="left-content">
               ...
               <div class="outter-wp">
                  <div class="set-1">
                     <div class="graph-2 general">
                        <h3 class="inner-tittle two">Create Gallery</h3>
                        <div class="grid-1">
                           <div class="form-body">
			...
			<table>
				<tr>
					<td class="form-group col-sm-4 control-label">IMG Name</tD>
					<td><input type="text" class="form-control1" name="gn"/></td>
				</tR>
            <tr>
