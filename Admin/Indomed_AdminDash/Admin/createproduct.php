...
if(isset($save))
{
	$query="select * from product where pname='$pn' ";
   ...
   $query="insert into product values('','$pn','$pdesc','$image')";	
	//upload image
    mkdir("image/$pn");
	move_uploaded_file($_FILES['pic']['tmp_name'],"image/$pn/".$_FILES['pic']['name']);
   ...
   <body>
      ...
      <div class="page-container">
         ...
         <div class="left-content">
               ...
               <div class="outter-wp">
                  <div class="set-1">
                     <div class="graph-2 general">
                        <h3 class="inner-tittle two">Create Product</h3>
                        <div class="grid-1">
                           <div class="form-body">
			...
			<table>
				<tr>
					<td class="form-group col-sm-4 control-label">Product Name</tD>
					<td><input type="text" class="form-control1" name="pn"/></td>
				</tR>
				<tr>
					<td class="form-group col-sm-4 control-label">Product Description</tD>
					<td><input type="text" class="form-control1" name="pdesc"/></td>
				</tR>
                <tr>
					<td class="form-group col-sm-4 control-label">Upload Your product pic</tD>
...
//display All records
	...
	echo "<Tr><th>Sr.No</th><th>Product Name</th><th>Product Desc</th><th>Product PIc</th>
	<th>Delete</th></tR>";
...
?>                      <!-- <tr> <th scope="row">EEA001</th> <td>Client Name 1</td> <td>Type1</td> <td>April, 2019</td> </tr> 
	  ...
	  <script>
			function deleteRecord(x)
			{
				...
				{
				window.location.href='productdelete.php?p_id='+x;	
